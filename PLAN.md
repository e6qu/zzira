...
| Service management | Help center, service projects, typed customer requests, participants, public/private conversation, status transitions, per-desk agents and queues, business calendars and first-response/resolution SLA cycles | Portals/forms, custom queues, organizations, conditional SLA goals/escalation, holidays, approvals, attachments, notifications, Assets, incident/problem/change management, service reports and remaining REST |
