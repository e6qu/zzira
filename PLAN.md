...
| Work management | Projects, issues, sub-task hierarchy, comments, attachments, worklogs, links, watchers, custom fields, security levels, notifications | Remaining Jira v3 operations, complete JQL/ADF, higher-level hierarchy, schemes and admin semantics |
