...
| Apps | Administrator-authorized installation/reinstallation with encrypted secrets, explicit scopes, signed and replay-protected lifecycle callbacks, isolated versioned JSON storage, stable scope-enforced app principals across Jira/Agile/JSM/Confluence REST, scope-safe upgrades, suspension/uninstall, audited administration, and host-rendered Jira/Confluence global pages, issue panels, dashboard gadgets and content byline items; core webhooks and entity properties | Connect JWT/QSH compatibility, outbound lifecycle delivery, remote modules, workflow/custom-field modules, app webhooks, scheduled triggers and upgrade migrations |
