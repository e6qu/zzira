...
| Service management | Help center, service projects, typed customer requests, participants, public/private conversation, status transitions, per-desk agents and queues, business calendars, first-response/resolution SLA cycles and durable escalation notifications | Portals/forms, custom queues, organizations, conditional SLA goals, holidays, approvals, attachments, customer notifications, Assets, incident/problem/change management, service reports and remaining REST |
