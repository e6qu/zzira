...
| Service management | Help center, service projects, typed customer requests, participants, public/private conversation and attachments, assigned-user approvals, status transitions, per-desk agents and queues, business calendars, first-response/resolution SLA cycles and durable escalation notifications | Portals/forms, custom queues, organizations, conditional SLA goals, holidays, approval configuration, customer notifications and feedback, Assets, incident/problem/change management, service reports and remaining REST |
