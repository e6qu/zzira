...
| Knowledge | Spaces, page tree, page editing, drafts, versions, trash, page/space labels across v1/v2, and threaded footer-comment collaboration with persisted likes/history/operations; 24 Confluence operations reviewed | Remaining Confluence v1/v2, content types, inline comments, attachments, restrictions, mentions, watches, live collaboration, macros, CQL and export |
