...
| Workflows | Directory, versioned draft editing, explicit publish/discard with audit, project assignment, runtime isolation from drafts, and transition enforcement | Status lifecycle, workflow schemes, conditions, validators, post-functions and visual designer persistence |
