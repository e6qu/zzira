...
| Apps | Administrator-authorized installation/reinstallation with encrypted secrets, explicit scopes, signed and replay-protected lifecycle callbacks, isolated versioned JSON storage, scope-safe upgrades, suspension/uninstall, audited administration, validated Jira/Confluence module registrations and host-rendered global navigation pages; core webhooks and entity properties | Connect JWT/QSH compatibility, outbound lifecycle delivery, remote modules, issue panels, dashboard gadgets, byline items, workflow/custom-field modules, app webhooks, scheduled triggers and app principals |
