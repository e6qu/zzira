...
| Knowledge | Spaces, page tree, page editing, drafts, versions, trash, labels, threaded page/attachment footer comments, page inline discussions with exact-text anchors and resolution, direct-user/group page restrictions, versioned attachment upload/download/properties/labels/thumbnails, and durable page/space/label watches with in-app delivery across v1/v2; 81 Confluence operations reviewed | Remaining Confluence v1/v2, content types, tasks, rich anchor relocation, Confluence-specific space roles, mentions, watch email delivery, live collaboration, macros, CQL and export |
