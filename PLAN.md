...
| Knowledge | Spaces, page tree, page editing, drafts, versions, trash, labels, threaded footer comments, direct-user/group page restrictions, and versioned page attachment upload/download across v1/v2; 48 Confluence operations reviewed | Remaining Confluence v1/v2, content types, inline and attachment comments, attachment properties/labels/thumbnails, space roles, mentions, watches, live collaboration, macros, CQL and export |
