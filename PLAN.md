...
| Knowledge | Spaces, page tree, page editing, drafts, versions, trash, and threaded footer-comment collaboration with seven reviewed Confluence v2 operations | Confluence v1, content types, inline comments, likes, comment history/operations, attachments, restrictions, mentions, watches, live collaboration, macros, CQL and export |
