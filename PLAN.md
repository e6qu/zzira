...
| Knowledge | Spaces, page tree, page editing, drafts, versions, trash, page/space labels across v1/v2, threaded footer-comment collaboration with persisted likes/history/operations, and direct-user/group page read/edit restrictions across all 12 legacy routes; 36 Confluence operations reviewed | Remaining Confluence v1/v2, content types, inline comments, attachments, space roles, mentions, watches, live collaboration, macros, CQL and export |
