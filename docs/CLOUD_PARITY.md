...
| Wiki and knowledge | Partial | Spaces, private spaces, page tree, storage subset, drafts, versions, trash/restore, threaded page footer comments with version-safe author/admin CRUD, persisted likes, comment history/operations, twelve reviewed Confluence v2 comment operations, and UI | Confluence v1; other content types; complete ADF/storage/macros; roles/restrictions; inline comments, attachments, labels, watches, CQL, templates, exports/imports and live collaboration |
