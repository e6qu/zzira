...
assesses 295 operations: 288 partial and 7 missing. The remaining 912 operations
...
| Wiki and knowledge | Partial | Spaces, private spaces, page tree, storage subset, drafts, versions, trash/restore, threaded page/attachment footer comments and page inline discussions with exact-text anchors and resolution, labels, direct-user/group page restrictions, versioned page attachments with upload, replacement, download, bounded image thumbnails, history, JSON properties and labels, plus durable page/space/label watches with synchronized deduplicated notifications across v1/v2; 81 reviewed Confluence operations and UI | Remaining Confluence v1/v2; other content types; complete ADF/storage/macros; richer media processing; Confluence-specific space roles; tasks; rich anchor relocation; watch email delivery; CQL, templates, exports/imports and live collaboration |
