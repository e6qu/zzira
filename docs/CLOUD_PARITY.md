...
assesses 283 operations: 276 partial and 7 missing. The remaining 924 operations
...
| Wiki and knowledge | Partial | Spaces, private spaces, page tree, storage subset, drafts, versions, trash/restore, threaded page and attachment footer comments, labels, direct-user/group page restrictions, versioned page attachments with upload, replacement, download, bounded image thumbnails, history, JSON properties and labels, plus durable page/space/label watches with synchronized deduplicated notifications across v1/v2; 69 reviewed Confluence operations and UI | Remaining Confluence v1/v2; other content types; complete ADF/storage/macros; richer media processing; Confluence-specific space roles; inline comments and tasks; watch email delivery; CQL, templates, exports/imports and live collaboration |
