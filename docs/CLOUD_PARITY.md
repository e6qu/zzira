...
| Wiki and knowledge | Partial | Spaces, private spaces, page tree, storage subset, drafts, versions, trash/restore, threaded footer comments, labels, direct-user/group page restrictions, and versioned page attachment upload, replacement, metadata, history, download and deletion across v1/v2; 48 reviewed Confluence operations and UI | Remaining Confluence v1/v2; other content types; complete ADF/storage/macros; attachment properties/labels/comments/thumbnails; space roles; inline comments, watches, CQL, templates, exports/imports and live collaboration |
