...
| Wiki and knowledge | Partial | Spaces, private spaces, page tree, storage subset, drafts, versions, trash/restore, threaded page footer comments with likes/history/operations, page and space labels across v1/v2, direct-user and organization-group page read/edit restrictions across all 12 v1 routes, 36 reviewed Confluence operations, and UI | Remaining Confluence v1/v2; other content types; complete ADF/storage/macros; space roles; inline comments, attachments, watches, CQL, templates, exports/imports and live collaboration |
