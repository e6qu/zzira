...
assesses 572 operations: 565 partial and 7 missing. The remaining 635 operations
...
| Projects and administration | Partial | Project create/edit across business, software and service-management types; Scrum/Kanban setup; project directory/settings; stable component lifecycle/default assignment; recent-project tracking; archive/restore/trash; synchronous and durable asynchronous deletion; automatic 60-day purge; replica coherence and attachment cleanup; numeric site-wide category lifecycle and project assignment; JSON project properties; software feature state with navigation enforcement; project sender overrides; project-type and key/name validation APIs; a durable shared project-role catalog; default and project-specific user/group actors; safe role swaps; role-backed filter sharing; all 16 permission-scheme, assignment, discovery, and evaluation operations; all nine notification-scheme operations; durable grants and event recipients across Jira holder types; permission-filtered project/issue/search/sync/notification surfaces; delegated project administration; plus durable Jira site feature settings, time tracking, navigator columns, editable application properties and dismissible announcements. Seventy project, permission, and notification operations and 13 site-configuration operations now have API/browser evidence; all 47 organization operations are reviewed with tested group/user/role/activity/event/domain/policy subsets and admin journeys | Security, workflow, screen and field schemes; global permission administration; custom notification events and preferences; action-specific permission enforcement across remaining mutations; import/export; complete templates/expansions; anonymous browse/discovery; app, guest and service role actors; custom-domain sender verification; app-provided features; complete look-and-feel application; Marketplace time providers; runtime network policy enforcement and cross-organization domain ownership; remaining Jira admin APIs and journeys; see [PROJECT_GOVERNANCE.md](PROJECT_GOVERNANCE.md), [PROJECT_LIFECYCLE.md](PROJECT_LIFECYCLE.md), [PROJECT_ROLES.md](PROJECT_ROLES.md), [PERMISSION_SCHEMES.md](PERMISSION_SCHEMES.md), and [NOTIFICATION_SCHEMES.md](NOTIFICATION_SCHEMES.md) |
