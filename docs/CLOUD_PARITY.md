...
assesses 159 operations: 152 partial and 7 missing. The remaining 1,048 operations
...
| Service Management | Partial | Service-project creation, atomic desk/request-type provisioning, customer help center and request form/list/detail journey, customer identities, public/internal conversation boundary, customer status transitions, incident-to-DORA linkage, and twenty pinned info/desk/type/customer/request operations | Dynamic forms, participants, organizations, queues, calendars, SLAs, approvals, attachments, notifications, feedback, Assets, incident/problem/change configuration, service reports and remaining REST operations; see [SERVICE_MANAGEMENT.md](SERVICE_MANAGEMENT.md) |
