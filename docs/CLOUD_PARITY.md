...
assesses 162 operations: 155 partial and 7 missing. The remaining 1,045 operations
...
| Service Management | Partial | Service-project creation, atomic desk/type/queue provisioning, customer help center and request journey, customer identities, public/internal conversation boundary, status transitions, incident-to-DORA linkage, agent queue/assignment workspace, and twenty-three pinned info/desk/type/customer/request/queue operations | Custom queues/JQL, project agent roles, dynamic forms, participants, organizations, calendars, SLAs, approvals, attachments, notifications, feedback, Assets, incident/problem/change configuration, service reports and remaining REST operations; see [SERVICE_MANAGEMENT.md](SERVICE_MANAGEMENT.md) |
