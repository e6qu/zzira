...
assesses 328 operations: 321 partial and 7 missing. The remaining 879 operations
...
| Wiki and knowledge | Partial | Spaces, private spaces, permission-filtered page trees with v1/v2 child/ancestor/descendant resources, nested folders and validated HTTP/HTTPS Smart Links with heterogeneous page/folder/link ancestors, bounded descendants, operation discovery and versioned JSON properties, storage subset, drafts, versions, trash/restore, threaded page/attachment footer comments, page inline discussions with exact-text anchors and resolution, and page tasks with assignment, due dates and completion, labels, direct-user/group page restrictions, versioned page attachments with upload, replacement, download, bounded image thumbnails, history, JSON properties and labels, plus durable page/space/label watches with synchronized deduplicated notifications across v1/v2; 114 reviewed Confluence operations and UI | Remaining Confluence v1/v2; databases, whiteboards, blogs and other non-page content; page children beneath non-page content and manual ordering; complete ADF/storage/macros including task extraction; richer media processing; Confluence-specific space roles; rich anchor relocation; watch email delivery; CQL, templates, exports/imports and live collaboration |
