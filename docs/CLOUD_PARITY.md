...
| Permissions | Permission, notification and issue security schemes enforced on every work item command; project roles; global permissions; anonymous REST reads ([PERMISSION_SCHEMES.md](PERMISSION_SCHEMES.md)) | Scheme copy in the UI ([Plan 1](../PLAN.md#1-work-item-model)) |
...
| Fields and screens | Work types on a configurable hierarchy, priorities, resolutions and their schemes, administered in the browser; custom fields, contexts and options; field configurations; screens and screen schemes ([JIRA_PLATFORM.md](JIRA_PLATFORM.md)) | [Plan 1](../PLAN.md#1-work-item-model): custom field admin, screen-backed transitions, scheme copy |
| Work items | Create, edit, transition, comments, links, attachments, votes, watches, worklogs, time tracking, properties, archive, bulk edit/move/transition/delete/watch ([ISSUE_SURFACE.md](ISSUE_SURFACE.md), [BULK_ISSUES.md](BULK_ISSUES.md)) | [Plan 1](../PLAN.md#1-work-item-model): classification, worklog fields, bulk work type and status |
...
| Boards and sprints | Scrum and Kanban boards, backlog, ranking, epics, estimation, board administrators, parallel sprints ([AGILE_BOARDS.md](AGILE_BOARDS.md)) | [Plan 4](../PLAN.md#4-boards-reports-and-dora): column and swimlane configuration |
| Plans | Plan REST, sources, exclusions, scenarios, teams, capacity, dependencies ([JIRA_SOFTWARE.md](JIRA_SOFTWARE.md)) | [Plan 2](../PLAN.md#2-plans): auto-scheduler, browser setup, views |
...
| Assets | Per-desk schemas, objects, relationships, request impact, portal field | [Plan 8](../PLAN.md#8-assets): object types, AQL, REST API, imports |
...
| Whiteboards and databases | Form-driven canvas with objects and connectors; databases | [Plan 11](../PLAN.md#11-whiteboards-and-diagrams) |
...
| Development integrations | Dev info, builds, deployments, feature flags, remote links, operations, security, deployment gating, rate limits | [Plan 13](../PLAN.md#13-apps): async processing, issue view panels |
