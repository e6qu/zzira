...
| Fields and screens | Work types, priorities, resolutions and their schemes; custom fields, contexts and options; field configurations; screens and screen schemes ([JIRA_PLATFORM.md](JIRA_PLATFORM.md)) | [Plan 1](../PLAN.md#1-work-item-model): hierarchy above epic, admin pages, screen-backed transitions, scheme copy |
