...
| Projects and administration | Partial | Project create/edit, Scrum/Kanban setup, project directory and settings entry points; organization/site/product/directory foundation; audited group lifecycle and search/stats, product roles, directory-user search/stats, atomic invitation assignments and durable email delivery, and account lifecycle | Permission, notification, security, workflow, screen and field schemes; profile depth, policies, domains and events; templates; project lifecycle; remaining admin APIs and journeys |
