...
| Search and filters | Partial | Useful JQL subset and navigator; all 19 pinned filter routes with private/shared visibility, owned/favorite collections, paginated search, user/group/project/role view and edit shares, favorites, columns, owner transfer and default scope | Full JQL grammar/functions/history, stable search cursors, scheduled subscription delivery and remaining search expansions; see [FILTERS.md](FILTERS.md) |
