...
assesses 343 operations: 336 partial and 7 missing. The remaining 864 operations
...
| Wiki and knowledge | Partial | Spaces, private spaces, permission-filtered page trees with v1/v2 child/ancestor/descendant resources, nested folders, validated HTTP/HTTPS Smart Links and creator-private database containers with heterogeneous page/folder/link/database ancestry, bounded descendants, operation discovery, versioned JSON properties and built-in classification state, storage subset, drafts, versions, trash/restore, threaded page/attachment footer comments, page inline discussions with exact-text anchors and resolution, page tasks with assignment, due dates and completion, labels, direct-user/group page restrictions, versioned page attachments with upload, replacement, download, bounded image thumbnails, history, JSON properties and labels, plus durable page/space/label watches with synchronized deduplicated notifications across v1/v2; 129 reviewed Confluence operations and UI | Remaining Confluence v1/v2; database schemas/rows/views and organization-defined classification levels; whiteboards, blogs and other non-page content; page children beneath non-page content and manual ordering; complete ADF/storage/macros including task extraction; richer media processing; Confluence-specific space roles; rich anchor relocation; watch email delivery; CQL, templates, exports/imports and live collaboration |
