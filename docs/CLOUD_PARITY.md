...
assesses 39 operations: 32 partial and 7 missing. The remaining 1,168 operations
...
| Projects and administration | Partial | Project create/edit, Scrum/Kanban setup, project directory and settings entry points; organization/site/product/directory foundation; audited groups, product roles, invitations and account lifecycle | Permission, notification, security, workflow, screen and field schemes; account search/stats/profile depth, policies, domains and events; templates; project lifecycle; remaining admin APIs and journeys |
