...
assesses 541 operations: 534 partial and 7 missing. The remaining 666 operations
...
| Projects and administration | Partial | Project create/edit across business, software and service-management types; Scrum/Kanban setup; project directory/settings; stable component lifecycle/default assignment; recent-project tracking; archive/restore/trash; synchronous and durable asynchronous deletion; automatic 60-day purge; replica coherence and attachment cleanup; numeric site-wide category lifecycle and project assignment; JSON project properties; software feature state with navigation enforcement; project sender overrides; project-type and key/name validation APIs; plus durable Jira site feature settings, time tracking, navigator columns, editable application properties and dismissible announcements. Thirty project operations and 13 site-configuration operations now have API/browser evidence; all 47 organization operations are reviewed with tested group/user/role/activity/event/domain/policy subsets and admin journeys | Permission, notification, security, workflow, screen and field schemes; import/export; complete templates/expansions; project-admin roles; anonymous browse; custom-domain sender verification; app-provided features; complete look-and-feel application; Marketplace time providers; runtime network policy enforcement and cross-organization domain ownership; remaining Jira admin APIs and journeys; see [PROJECT_GOVERNANCE.md](PROJECT_GOVERNANCE.md) and [PROJECT_LIFECYCLE.md](PROJECT_LIFECYCLE.md) |
