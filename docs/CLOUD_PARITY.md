...
| Wiki and knowledge | Partial | Spaces, private spaces, page tree, storage subset, drafts, versions, trash/restore, threaded footer comments, labels, direct-user/group page restrictions, and versioned page attachments with upload, replacement, download, history, JSON properties and labels across v1/v2; 55 reviewed Confluence operations and UI | Remaining Confluence v1/v2; other content types; complete ADF/storage/macros; attachment comments/thumbnails; space roles; inline comments, watches, CQL, templates, exports/imports and live collaboration |
