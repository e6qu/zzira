...
| Releases | Partial | Version lifecycle, fix/affects assignment, progress, notes, release/archive/delete, explicit project-wide ordering with browser reordering, drivers and approvers with decisions, related work, and version-picker custom fields | `moveUnfixedIssuesTo`, exports, cross-project releases and full permissions; see [RELEASES.md](RELEASES.md) |
