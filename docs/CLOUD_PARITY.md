...
| Service Management | Partial | Service-project creation, atomic service-desk provisioning, default help/incident request types and nine pinned info/service-desk/request-type operations with project/admin browser coverage | Customer portal, customers, requests, conversations, participants, queues, SLAs, approvals, Assets, incident/problem/change configuration, reports and remaining REST operations |
