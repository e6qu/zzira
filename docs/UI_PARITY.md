...
| Space manager governs knowledge | Partial | ✅ Public/private space creation, role-shaped operation discovery, page lifecycle, an accessible default-classification control inherited by new pages and blog posts, and versioned JSON app-property management; Confluence-specific roles, granular permissions, templates, analytics, archive/import/export and organization-defined classification levels remain |
