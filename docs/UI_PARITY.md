...
| Contributor follows code through release | 🟡 | `directories` (development information), `software`, `releases`, `plans_setup` (cross-project releases, and the release hub reading one back) | Release gates; environment promotion ([RELEASES](RELEASES.md#gaps)) |
