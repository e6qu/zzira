...
| Site admin manages people and access | Partial | ✅ Organization/site/product foundation, directory group create/delete, per-product and invitation-time access, durable invitation email, suspend/restore/remove, credential revocation and audit; account depth, policies, providers and remaining central APIs remain |
