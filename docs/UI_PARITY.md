...
| Manager plans across teams | 🟡 | `timeline`, `plans_view`, `plans_teams`, `plans_setup` (create, scheduling, sources, exclusions, cross-project releases, access) | Auto-scheduler; rollups above epic ([JIRA_SOFTWARE](JIRA_SOFTWARE.md#gaps)) |
