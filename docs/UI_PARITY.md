...
| Service manager runs a service | 🟡 | `service`, `service_assets` | Attachments, comments and history on an object ([SERVICE_MANAGEMENT](SERVICE_MANAGEMENT.md#assets-api)) |
