...
| Site admin manages apps | Partial | ✅ Encrypted descriptor installation and reinstallation, stable non-human principals with signed scope-enforced Jira/Agile/JSM/Confluence API access, explicit scope/module review, active/suspended/uninstalled lifecycle controls, organization audit, isolated storage, and host-rendered global navigation, issue panels, custom-dashboard gadgets and wiki byline items; Connect/Forge descriptor parity, remote modules, app webhooks, schedules, workflow/custom-field modules and upgrade migrations remain |
