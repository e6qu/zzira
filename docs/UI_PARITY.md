...
| Knowledge user authors and discusses a page | Partial | ✅ Space/page create, storage editor, drafts, parents, history, search, trash/restore, threaded footer comments/replies, likes, comment version history, author editing/deletion and administrator moderation; complete editor, inline comments, attachments, restrictions, mentions, watches and live collaboration remain |
