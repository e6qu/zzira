...
| Site admin manages apps | Partial | ✅ Encrypted descriptor installation and reinstallation, explicit scope/module review, active/suspended/uninstalled lifecycle controls, organization audit, and host-rendered global module navigation; Connect/Forge descriptor parity, app principals, remote modules, issue/dashboard/wiki surfaces, webhooks, schedules and upgrade migrations remain |
