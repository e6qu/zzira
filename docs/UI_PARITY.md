...
| Knowledge user authors and discusses a page | Partial | ✅ Space/page create, storage editor, drafts, parents, history, search, trash/restore, page labels, threaded footer comments/replies, likes, comment version history, direct-user/group view and edit restrictions, author/member access handoffs, author editing/deletion and administrator moderation; complete editor, inline comments, attachments, mentions, watches and live collaboration remain |
