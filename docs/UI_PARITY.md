...
| Manager configures a project | Partial | ✅ Scrum/Kanban create, details, lead/default assignment, workflow selection, and responsive component create/edit/delete with leads, assignment policy and move-on-delete; roles, types, fields, screens, remaining schemes, security and lifecycle remain |
