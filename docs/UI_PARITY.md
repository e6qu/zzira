...
| Agile coach diagnoses delivery | Partial | ✅ Permission-filtered sprint report with completed, incomplete, outside and removed work, added-after-start and re-estimate markers, remaining-estimate burndown against the guideline with its change table, and a seven-sprint velocity chart of commitment against completed work, by board estimation field or issue count, with dark theme and 320 px reflow; burnup, epic and version reports, cumulative-flow and control-chart journeys remain |
