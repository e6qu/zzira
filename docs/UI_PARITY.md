...
| Knowledge user authors and discusses a page | Partial | ✅ Space/page create, storage editor, drafts, parents, history, search, trash/restore, labels, threaded footer comments/replies, likes/history, direct-user/group view/edit restrictions, and permission-scoped attachment upload, replacement, download, deletion, labels and versioned JSON properties; complete editor, inline and attachment comments, mentions, watches and live collaboration remain |
