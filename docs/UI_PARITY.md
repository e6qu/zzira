...
| Agile coach diagnoses delivery | 🟡 | `backlog` (sprint report, velocity), `reports_flow`, `reports_progress`, `reports_workload`, `report_subscriptions`, `dashboard_reports` | Release burndown and epic burndown ([REPORTS](REPORTS.md#gaps)) |
