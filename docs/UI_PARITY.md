...
| Service agent works a queue | Partial | ✅ Service-desk queue selection, all-open/unassigned/assigned-to-me views, responsive request table, take/unassign ownership, request detail, private collaboration and workflow actions; project-scoped agent roles, custom queues, SLAs, approvals and escalation remain |
