...
| Manager builds an operating dashboard | Partial | ✅ Configurable dashboards, layouts, favourites, sharing, refresh, native work-item gadgets, created vs. resolved, resolution time, velocity and sprint burndown report gadgets, and signed remote standard Connect items; complete shares, subscriptions, exports and Connect item configuration remain |
