...
| Manager builds an operating dashboard | Partial | ✅ Configurable dashboards, layouts, favourites, sharing, refresh, native work-item gadgets, created vs. resolved, resolution time, velocity and sprint burndown report gadgets, signed remote standard Connect items, and daily or weekly dashboard emails that give each recipient the gadgets as they see them; anonymous dashboards, exports and Connect item configuration remain |
...
| Knowledge team collaborates live | Partial | ✅ Presence with who is editing, update and comment notices, and live editing of published pages and blog posts: a shared revisioned document merges concurrent typing in the rich editor or source mode, keeps carets in place, drafts valid merged text and restarts on publish; remote cursors and offline live edits remain; durable page tasks, inline discussions and watch notifications are available |
