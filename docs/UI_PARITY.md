...
| Knowledge user authors and discusses a page | Partial | ✅ Space/page create, storage editor, drafts, parents, history, search, trash/restore, labels, threaded page and attachment footer comments/replies, likes/history, direct-user/group view/edit restrictions, permission-scoped attachment upload/replacement/download/deletion/labels/versioned JSON properties, and page/space/label watches that open deduplicated in-app notifications; complete editor, inline comments, mentions, watch email delivery and live collaboration remain |
| Knowledge team collaborates live | Missing | Live documents, presence, concurrent operations, inline discussion and tasks remain; durable watch notifications are available |
