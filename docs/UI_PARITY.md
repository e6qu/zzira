...
| Service customer requests help | Partial | ✅ Help-center and portal discovery, typed help/incident request submission, owned request list/detail, public conversation, status and condition-aware transitions with light/dark accessibility and 320 px reflow; knowledge suggestions, dynamic forms, participants, attachments, approvals, notifications and feedback remain |
