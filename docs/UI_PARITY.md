...
| Manager plans across teams | 🟡 | `timeline`, `plans_view`, `plans_teams`, `plans_setup` (create, scheduling, sources, exclusions, access) | Auto-scheduler; rollups above epic; releases in plans; velocity-based capacity; plan views ([JIRA_SOFTWARE](JIRA_SOFTWARE.md#gaps)) |
