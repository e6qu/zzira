...
| Contributor creates and triages work | ✅ | Shared create metadata, validation recovery, one-level sub-task creation and reassignment, parent/child navigation, inline fields, security, labels, watchers, links, activity, attachments and worklogs |
