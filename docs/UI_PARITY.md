...
| Admin automates work | 🟡 | `automation` (schedules, work item events including assigned, attachment added, deleted, moved, versions and sprints, webhooks, branches, conditions, the action catalog) | Triggers for Confluence content; the rest of the catalog ([AUTOMATION](AUTOMATION.md#gaps)) |
