...
| Manager builds an operating dashboard | Partial | ✅ Configurable dashboards, layouts, favourites, sharing, refresh, native work-item gadgets and signed remote standard Connect items; report gadgets, complete shares, subscriptions, exports and Connect item configuration remain |
...
| Knowledge team collaborates live | Partial | ✅ Presence with who is editing, update and comment notices, and live editing of published pages: a shared revisioned document merges concurrent typing in the rich editor or source mode, keeps carets in place, drafts valid merged text and restarts on publish; blog post co-editing, remote cursors and offline live edits remain; durable page tasks, inline discussions and watch notifications are available |
