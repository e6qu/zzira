...
| Manager plans across teams | Partial | ✅ Software project timeline of epics and their child work across whole months, with start and due date bars, open-ended bars for half-scheduled work, today marker, per-row scheduling and permission-filtered work, governed by the project's Roadmap feature; teams, capacity, dependencies, scenarios and cross-project plans remain |
