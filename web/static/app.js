...
(function () {
  ...
  function initShell() {
    ...
    document.addEventListener('pointerdown', (event) => {
      const target = event.target;
      document.querySelectorAll('details.project-switcher[open], details.user-menu[open], details.app-switcher[open], details.more-menu[open], details.column-picker[open], details.save-search[open], details.board-card-move[open], details.backlog-item-menu[open], details.create-sprint[open], details.edit-sprint[open], details.start-sprint[open]').forEach((details) => {
