...
| Confluence Cloud spaces, pages, labels, restrictions, attachments and footer comments | 🟡 | Initial v2 space/page CRUD, drafts, versions, trash/restore, footer-comment collaboration, labels, all 12 v1 page-restriction operations, and 19 v1/v2 versioned page-attachment, property and label operations across 55 reviewed operations, plus permission-filtered action log; exact limits in CLOUD_PARITY.md |
