...
| Service management surfaces | 🟡 | Service-project creation plus twenty-three pinned info/desk/type/customer/request/queue operations, default help/incident types and agent queues, customer request journey, public/internal conversations, assignment, status transitions and incident-to-DORA linkage; dynamic forms, participants, custom queues, SLAs, approvals, Assets and remaining operations remain |
