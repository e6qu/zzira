...
| Service management surfaces | 🟡 | Service-project creation plus nine pinned info/service-desk/request-type operations, default help/incident types and request field metadata; customer portal, requests, conversations, queues, SLAs, approvals, Assets and remaining operations remain |
