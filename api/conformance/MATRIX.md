...
| Organizations orgs · directories · users · groups · memberships · workspaces · roles | 🟡 | Bearer auth, site-admin permission, product ARIs, direct/effective roles, group detail/search/count/stats/delete, directory-user search/stats, atomic invitation roles/groups and durable email, suspend/restore/remove with credential revocation, and audit delivered; broader 47-operation contract remains |
