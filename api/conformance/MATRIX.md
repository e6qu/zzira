...
| Screens, screen tabs and tab fields | 🟡 | All 17 Jira v3 operations share durable screens, sequence-backed IDs, a validated field catalog, dense tab/field ordering, structural guards on the last tab and the default screen, immutable actions and a responsive admin journey; screen schemes, issue type screen schemes and the binding to work item forms remain; exact boundary in [SCREENS.md](../../docs/SCREENS.md) |
| Screen schemes and issue type screen schemes | ⛔ | editmeta serves the form contract until screens are bound to projects |
