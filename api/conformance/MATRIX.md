...
| Service management surfaces | 🟡 | Service-project creation plus twenty-six pinned info/desk/type/customer/request/queue operations, default help/incident types and agent queues, customer request journey, participants, public/internal conversations, assignment, status transitions and incident-to-DORA linkage; dynamic forms, custom queues, SLAs, approvals, Assets and remaining operations remain |
