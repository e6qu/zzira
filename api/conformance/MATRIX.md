...
| Service management surfaces | 🟡 | Service-project creation plus twenty pinned info/desk/type/customer/request operations, default help/incident types, customer portal request journey, public/internal conversations, status transitions and incident-to-DORA linkage; dynamic forms, participants, queues, SLAs, approvals, Assets and remaining operations remain |
