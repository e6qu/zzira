		...
		WHERE a.workspace_id=$1 AND a.seq > $2 AND a.seq <= $6
		  ...
		  AND (a.entity_type NOT IN ('wiki_space','wiki_page','wiki_page_like','wiki_page_property','wiki_blogpost','wiki_blogpost_property','wiki_blogpost_label','wiki_blogpost_like','wiki_footer_comment','wiki_footer_comment_like','wiki_inline_comment','wiki_inline_comment_like','wiki_task','wiki_label','wiki_restriction','wiki_attachment','wiki_attachment_property','wiki_content','wiki_content_property') OR EXISTS (
		    SELECT 1 FROM wiki_spaces s WHERE s.workspace_id=$1
		      ...
		      AND (a.entity_type NOT IN ('wiki_footer_comment','wiki_footer_comment_like','wiki_inline_comment','wiki_inline_comment_like','wiki_task') OR
		        COALESCE(a.payload->'wiki_footer_comment'->>'blogPostId',a.payload->'wiki_footer_comment_like'->>'blogPostId',a.payload->'wiki_inline_comment'->>'blogPostId',a.payload->'wiki_inline_comment_like'->>'blogPostId',a.payload->'wiki_task'->>'blogPostId','')='' OR
		        ((a.payload->>'blogPublished'='true' OR a.payload->>'blogAuthorId'=$3) AND (COALESCE((a.payload->>'blogPrivate')::boolean,false)=false OR a.payload->>'blogAuthorId'=$3)))
		      ...
		      ) OR COALESCE(a.payload->'wiki_footer_comment'->>'blogPostId',a.payload->'wiki_footer_comment_like'->>'blogPostId',a.payload->'wiki_inline_comment'->>'blogPostId',a.payload->'wiki_inline_comment_like'->>'blogPostId',a.payload->'wiki_task'->>'blogPostId','')<>'' OR COALESCE(a.payload->'wiki_footer_comment'->>'customContentId','')<>'')
		      ...
		      AND (a.entity_type NOT IN ('wiki_page','wiki_page_like','wiki_page_property','wiki_blogpost','wiki_blogpost_property','wiki_blogpost_label','wiki_blogpost_like','wiki_footer_comment','wiki_footer_comment_like','wiki_inline_comment','wiki_inline_comment_like','wiki_task','wiki_label','wiki_restriction','wiki_attachment','wiki_attachment_property','wiki_content','wiki_content_property')
		        ...
		        OR a.entity_type IN ('wiki_footer_comment','wiki_footer_comment_like','wiki_inline_comment','wiki_inline_comment_like','wiki_task') AND
		          COALESCE(a.payload->'wiki_footer_comment'->>'blogPostId',a.payload->'wiki_footer_comment_like'->>'blogPostId',a.payload->'wiki_inline_comment'->>'blogPostId',a.payload->'wiki_inline_comment_like'->>'blogPostId',a.payload->'wiki_task'->>'blogPostId','')<>''
