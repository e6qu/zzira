...
var systemWikiSpaceRoles = []*models.WikiSpaceRole{
	{ID: "system-admin", Type: "SYSTEM", Name: "Space administrators", Description: "Administer the space and all of its content.", SpacePermissions: []string{"administer/space", "read/space", "create/page", "read/page", "update/page", "delete/page", "create/blogpost", "read/blogpost", "update/blogpost", "delete/blogpost", "create/comment", "read/comment", "update/comment", "delete/comment", "create/attachment", "read/attachment", "update/attachment", "delete/attachment", "create/folder", "read/folder", "update/folder", "delete/folder", "create/embed", "read/embed", "update/embed", "delete/embed", "create/database", "read/database", "update/database", "delete/database", "create/whiteboard", "read/whiteboard", "update/whiteboard", "delete/whiteboard", "create/custom", "read/custom", "update/custom", "delete/custom"}},
	...
	{ID: "system-viewer", Type: "SYSTEM", Name: "Space viewers", Description: "Read the space and its published knowledge content.", SpacePermissions: []string{"read/space", "read/page", "read/blogpost", "read/comment", "read/attachment", "read/folder", "read/embed", "read/database", "read/whiteboard", "read/custom"}},
}
