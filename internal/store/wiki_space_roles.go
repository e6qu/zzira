...
var systemWikiSpaceRoles = []*models.WikiSpaceRole{
	{ID: "system-admin", Type: "SYSTEM", Name: "Space administrators", Description: "Administer the space and all of its content.", SpacePermissions: []string{"administer/space", "create/page", "read/page", "update/page", "delete/page", "create/blogpost", "read/blogpost", "update/blogpost", "delete/blogpost"}},
	{ID: "system-member", Type: "SYSTEM", Name: "Space members", Description: "Create, read, update and delete knowledge content.", SpacePermissions: []string{"read/space", "create/page", "read/page", "update/page", "delete/page", "create/blogpost", "read/blogpost", "update/blogpost", "delete/blogpost"}},
	{ID: "system-viewer", Type: "SYSTEM", Name: "Space viewers", Description: "Read the space and its published knowledge content.", SpacePermissions: []string{"read/space", "read/page", "read/blogpost"}},
}
