...
var reportPath = regexp.MustCompile(`^/(projects/[A-Za-z0-9_-]{1,64}/reports/(dora|sprint|velocity|cumulative-flow|control-chart|epic|version|created-vs-resolved|resolution-time|user-workload|version-workload|time-tracking|group-by|epic-burndown|release-burndown|deployment-frequency|cycle-time)|service/agent/[A-Za-z0-9_.:-]{1,128}/reports)$`)
