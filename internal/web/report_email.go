...
var reportPath = regexp.MustCompile(`^/(projects/[A-Za-z0-9_-]{1,64}/reports/(dora|sprint|velocity|cumulative-flow|control-chart|epic|version|created-vs-resolved|resolution-time)|service/agent/[A-Za-z0-9_.:-]{1,128}/reports)$`)
