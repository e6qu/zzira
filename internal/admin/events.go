...
var organizationEventActions = map[string]string{
	...
	"policy.resource.added":               "Policy resource added",
	"policy.resource.removed":             "Policy resource removed",
	"policy.resource.updated":             "Policy resource updated",
	...
	"service.request_type.fields.updated": "Service request form updated",
	"service.sla.updated":                 "Service SLA updated",
	"service.sla.goal.created":            "Service SLA goal created",
	"service.sla.goal.deleted":            "Service SLA goal deleted",
	"service.sla.goal.updated":            "Service SLA goal updated",
