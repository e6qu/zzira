...
// TestMain provisions the administrator required by command integration tests.
...
func TestMain(m *testing.M) {
	...
	if err := st.EnsureBootstrapAdmin(context.Background(), "command-tests@zzira.invalid", "Command test administrator", "!test-only!", "admin"); err != nil {
